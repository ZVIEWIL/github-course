...
public class GanttChartExample extends JFrame {
	...
	public Projeto(String nome){
	   ...
	   public GanttChartExample(String title) {
	    ...
	    String Projeto1 = JOptionPane.showInputDialog("Nome do Projeto:");	    
	    
		
		String Tarefa1 = JOptionPane.showInputDialog("Nome da Tarefa 1:");
		
		String dataInicio = JOptionPane.showInputDialog("Data de Inicio: (dd/m/aaaa)");
		...
		String dataFim = JOptionPane.showInputDialog("Data Final: (dd/mm/aaaa)");
